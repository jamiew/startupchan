# watchlater deployment

# TODO needs support for running migrations
# TODO need memcache jobz, including migration->memcache flush

require 'bundler/capistrano'

set :application, 'bboard'
set :deploy_to, "/home/jamie/youbeweed"
set :scm,        :git
